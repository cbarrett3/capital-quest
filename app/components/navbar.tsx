export const Navbar = () => {
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white/60 backdrop-blur-lg border-b-[3px] border-gradient-to-r from-emerald-500 via-violet-500 to-rose-500">
